...
- Scene ID: `SC0071`
- Raw slug / anchor: `INT. KASPAR TERMINAL — STAFF ROOM — EVENING`
- Raw location string: `KASPAR TERMINAL — STAFF ROOM`
- Raw time-of-day string: `EVENING`
- Boundary start kind: `slug`
- Mapping confidence: `high`
- Explicit dialogue characters: `MARCUS`, `NADIA`
