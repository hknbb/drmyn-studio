...
- Scene ID: `SC0050`
- Raw slug / anchor: `INT. MERIN — QUAY DISTRICT, UNIT 14-B — LATE MORNING`
- Raw location string: `MERIN — QUAY DISTRICT, UNIT 14-B`
- Raw time-of-day string: `LATE MORNING`
- Boundary start kind: `slug`
- Mapping confidence: `high`
- Explicit dialogue characters: `TOBIAS`, `NADIA`, `OTTO`
- Explicit mention characters: `OTTO`, `TOBIAS`
