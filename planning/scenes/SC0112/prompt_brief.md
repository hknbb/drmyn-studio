...
- Scene ID: `SC0112`
- Raw slug / anchor: `INT. VELTAIN COMPOUND — ANTECHAMBER CORRIDOR — CONTINUOUS`
- Raw location string: `VELTAIN COMPOUND — ANTECHAMBER CORRIDOR`
- Raw time-of-day string: `CONTINUOUS`
- Boundary start kind: `cont_slug`
- Mapping confidence: `medium`
- Explicit dialogue characters: _None detected_
- Explicit mention characters: `FILING`, `ASSET`, `SUBMISSION`, `CASS WREN`
