...
- Scene ID: `SC0072`
- Raw slug / anchor: `INT. KASPAR TERMINAL — SERVICE CORRIDOR — NIGHT`
- Raw location string: `KASPAR TERMINAL — SERVICE CORRIDOR`
- Raw time-of-day string: `NIGHT`
- Boundary start kind: `slug`
- Mapping confidence: `high`
- Explicit dialogue characters: `CHEN MEI`, `NADIA`
