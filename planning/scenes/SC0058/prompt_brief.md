...
- Scene ID: `SC0058`
- Raw slug / anchor: `INT. REGIONAL BUS — FORWARD SECTION — LATE AFTERNOON`
- Raw location string: `REGIONAL BUS — FORWARD SECTION`
- Raw time-of-day string: `LATE AFTERNOON`
- Boundary start kind: `slug`
- Mapping confidence: `high`
- Explicit dialogue characters: _None detected_
- Explicit mention characters: `RESCUE ROUTE`
