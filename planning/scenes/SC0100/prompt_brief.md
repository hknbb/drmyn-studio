...
- Scene ID: `SC0100`
- Raw slug / anchor: `INT. VELTAIN COMPOUND — SERVICE CORRIDOR / EAST FACE — CONTINUOUS`
- Raw location string: `VELTAIN COMPOUND — SERVICE CORRIDOR / EAST FACE`
- Raw time-of-day string: `CONTINUOUS`
- Boundary start kind: `cont_slug`
- Mapping confidence: `medium`
- Explicit dialogue characters: `THE HERALD`
- Explicit mention characters: `NADIA`
