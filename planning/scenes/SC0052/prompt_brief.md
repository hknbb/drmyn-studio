...
- Scene ID: `SC0052`
- Raw slug / anchor: `INT. EASTBOUND TRAIN — FORWARD-FACING SEAT — LATE MORNING`
- Raw location string: `EASTBOUND TRAIN — FORWARD-FACING SEAT`
- Raw time-of-day string: `LATE MORNING`
