...
- Scene ID: `SC0067`
- Raw slug / anchor: `INT. COLD-STORE EQUIPMENT SHELTER — MERIN WATERFRONT — MORNING`
- Raw location string: `COLD-STORE EQUIPMENT SHELTER — MERIN WATERFRONT`
- Raw time-of-day string: `MORNING`
