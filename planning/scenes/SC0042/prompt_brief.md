...
- Scene ID: `SC0042`
- Raw slug / anchor: `INT. ROMAN'S OPERATIONAL OFFICE — HIGH FLOOR — NIGHT`
- Raw location string: `ROMAN'S OPERATIONAL OFFICE — HIGH FLOOR`
- Raw time-of-day string: `NIGHT`
- Boundary start kind: `slug`
- Mapping confidence: `high`
- Explicit dialogue characters: `DIMITRI`, `ROMAN`
- Explicit mention characters: `DIMITRI KOSS`
