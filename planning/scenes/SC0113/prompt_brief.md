...
- Scene ID: `SC0113`
- Raw slug / anchor: `INT. VELTAIN COMPOUND — INTERNAL CORRIDOR / SERVICE DESCENT — CONTINUOUS`
- Raw location string: `VELTAIN COMPOUND — INTERNAL CORRIDOR / SERVICE DESCENT`
- Raw time-of-day string: `CONTINUOUS`
- Boundary start kind: `cont_slug`
- Mapping confidence: `medium`
- Explicit dialogue characters: _None detected_
- Explicit mention characters: `PASSIVE`, `BEARING`, `LAST`
