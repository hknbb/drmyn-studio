...
- Scene ID: `SC0062`
- Raw slug / anchor: `INT. 14 HAVEL COURT — SAFE HOUSE UNIT — THIRD FLOOR — PRE-DAWN`
- Raw location string: `14 HAVEL COURT — SAFE HOUSE UNIT — THIRD FLOOR`
- Raw time-of-day string: `PRE-DAWN`
- Boundary start kind: `slug`
- Mapping confidence: `high`
- Explicit dialogue characters: _None detected_
- Explicit mention characters: `ORACLE PRIME`, `SUBJECT REACHES`, `WARNING`
